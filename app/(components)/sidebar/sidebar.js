...
const Sidebar = ({ isOpen }) => {
  ...
  return (
    <div className={`bg-zinc-200 pr-3 z-50 fixed transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform ease-in-out duration-300 md:translate-x-0`}>
      ...
      <div className="w-[190px] z-40 h-[777px] flex flex-row items-start justify-start text-left text-[22px] text-white font-inter">
        ...
        <div className="  self-stretch w-[35px] shrink-0 max-w-[55px] flex flex-row items-center z-80 ">
          ...
          <div className="self-stretch flex-1 relative [background:linear-gradient(360deg,_#505c2c,_#637721_42.08%,_#a7cb31)] overflow-hidden" />
        </div>
        <div className={`w-[190px] z-20 flex flex-col items-end justify-center ml-[-35px] transform ${isOpen ? 'translate-y-0' : '-translate-y-full'} transition-transform ease-in-out duration-300 md:translate-y-0`}>
          <div className="flex flex-col items-end justify-center py-[42px] px-0">
            <div className="w-[190px] h-[60px] flex flex-col items-center justify-center py-0 pr-[29px] pl-3.5 box-border">
              ...
              >
                <div className="w-5 flex flex-row items-center justify-center py-3.5 pr-0 pl-1 box-border">
            ...
            <div className="w-[140px] h-[140px] pt-3 flex flex-col items-center justify-center gap-[8px] text-base">
              <div
                className="self-stretch flex-1  flex flex-row items-center justify-center py-[4px] px-0 hover:cursor-pointer
              ...
              >
                <b className="relative">Allocation</b>
              </div>
              <div
                className="self-stretch flex-1 flex flex-row items-center justify-center py-[4px] px-0 hover:cursor-pointer
                hover:animate-[1s_ease-in_0s_infinite_alternate-reverse_none_shadow-pop-tr] hover:opacity-[1]"
              ...
              >
                <b className="relative">Signout</b>
              </div>
            </div>
          </div>
        </div>
